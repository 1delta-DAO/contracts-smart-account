...
async function main() {
    ...
    const sweeperModuleFactory = await ethers.getContractFactory('SweeperModuleGoerli')
...
main()
    ...
    // Margin Trader 0xBC81B9423aa6d9dCbFaCCC69047264e7ff262AE6
    // Money Market 0x12c61518c6e59e9b1Eb46Bb58512696a52c67BAC
    // Uniswap Callback 0x3bdA8e1FF902F185174295437f4C8cb0a18854F2
    // Sweeper 0x9a81727D61e4D6C966c181DaCE99F80a0B1eE01e

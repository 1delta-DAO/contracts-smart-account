...
async function main() {
    ...
    const manager = (marginSwapAccountAddresses.moduleManager as any)[chainId][chainId]
...
main()
    ...
    // Deploy OneDeltaAccountFactory on 5 by 0x4d6f46Ff41908A0920986aab432ab4A98E5Cbdeb
    // Account Factory proxy 0x9D0980F620081158Fb2E915404A49A36F92899ef
    // Account Factory logic 0x54B04bA307A52A1e53911f8D6f6D148510204689

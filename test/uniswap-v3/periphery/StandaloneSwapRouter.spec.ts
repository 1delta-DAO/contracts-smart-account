...
import { IWETH9, MockTimeNonfungiblePositionManager, MinimalSwapRouter, TestERC20Periphery } from '../../../types'
import completeFixture, { completeStandaloneFixture } from './shared/completeFixture'
...
describe('SwapRouter', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    const { weth9, factory, router, tokens, nft } = await completeStandaloneFixture(wallets, provider)
